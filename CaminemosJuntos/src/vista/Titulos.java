...
public class Titulos extends javax.swing.JInternalFrame {
    ...
    Titulo titulo, tituloModificado = null;
    CtrlTitulo ctrlTitulo = null;
    DefaultTableModel modeloTabla = null;
    int id, idModifica;
    boolean modifica = false;
    
    public Titulos(Connection cnx) {
        titulo = new Titulo();
        //tituloModificado = new Titulo();
    ...
    private void initComponents() {
        ...
        setTitle("Titulos de Profesionales");
    ...
    private void txtNuevoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtNuevoFocusLost
        ...
        {
            titulo = ctrlTitulo.leer(txtNuevo.getText());
            if(titulo == null || titulo.isBorrado() )
            {
    ...
    private void btnGrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGrabarActionPerformed
        if(modifica)
        {
            tituloModificado.setTitulo(txtNuevo.getText().trim().toUpperCase());

            ctrlTitulo.editar(tituloModificado);
        ...
        {
            if(titulo != null)
                ctrlTitulo.recuperar(titulo.getIdTitulo());
            else
            {
                titulo = new Titulo();
                titulo.setTitulo(txtNuevo.getText().trim().toUpperCase());
                ctrlTitulo.crear(titulo);
            }
        }
        txtNuevo.requestFocus();
        txtNuevo.setText("");
    ...
    private void btnBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBorrarActionPerformed
        ...
        {    
            ctrlTitulo.borrar(titulo.getIdTitulo());

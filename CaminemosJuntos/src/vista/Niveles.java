...
public class Niveles extends javax.swing.JInternalFrame {
    ...
    Nivel nivel;
    Nivel nivelModificado = null;
    CtrlNivel ctrlNivel = null;
    DefaultTableModel modeloTabla = null;
    int id, idModifica;
    boolean modifica = false;
    
    public Niveles(Connection cnx) {
        nivel = new Nivel();
    ...
    private void initComponents() {
        ...
        setTitle("Niveles de Integracion");
    ...
    private void txtNuevoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtNuevoFocusLost
        ...
        {
            nivel = ctrlNivel.leer(txtNuevo.getText());
            if(nivel == null)
            {
    ...
    private void btnGrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGrabarActionPerformed
        if(modifica)
        {
            nivelModificado.setNivel(txtNuevo.getText().trim().toUpperCase());

            ctrlNivel.editar(nivelModificado);
        ...
        {
            nivel = new Nivel();
            nivel.setNivel(txtNuevo.getText().trim().toUpperCase());
            ctrlNivel.crear(nivel);
        }
        txtNuevo.requestFocus();
        txtNuevo.setText("");
        cargarTabla();
    ...
    private void btnBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBorrarActionPerformed
        ...
        {    
            ctrlNivel.borrar(nivel.getIdNivel());

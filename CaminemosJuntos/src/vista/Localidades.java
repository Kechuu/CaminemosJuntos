...
public class Localidades extends javax.swing.JInternalFrame {
    ...
    LugarDomicilio lugar, lugarAModificar, prvnc, dprtmnt = null;
    CtrlLugarDomicilio ctrlLugar = null;
    DefaultTableModel modeloTabla = null;
    int id;
    boolean modifica = false;
    List<String> listaProvincias, listaDepartamentos = null;
    
    public Localidades(Connection cnx) {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(355, 425));
    ...
    private void txtNuevoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtNuevoFocusLost
        if(!txtNuevo.getText().equals("") && dprtmnt != null)
        {
            lugar = ctrlLugar.leer(txtNuevo.getText(), 3, dprtmnt.getIdLugarDomicilio());
            if(lugar != null)
            {
    ...
    public void cargarTabla()
    {
        if(dprtmnt != null)
        {
            ...
            listaLugares = ctrlLugar.leerTodosDe(dprtmnt);
